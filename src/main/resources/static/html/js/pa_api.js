...
var v_app = new Vue({
    ...
    data: {
        ...
        selected_json_url: '',
        api_json_url:[
            {title:'接口描述文件',url:'http://api.pa.91renta.com/api.json'}
        ],
    ...
    methods:{
        ...
        request_api:function () {
            var api_test_url = "http://api.8raw.com/public/index.php/Index/newest";
            ...
            data.append("app_id",this.api_data.client_id);
