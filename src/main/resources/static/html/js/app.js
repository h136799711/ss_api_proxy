...
var v_app = new Vue({
    ...
    data: {
        ...
        selected_json_url: '',
        api_json_url:[
            {title:'纺织快车guannan.8raw.com',url:'http://api.guannan.8raw.com/public/app.json'},
            {title:'经贸四方合作',url:'http://api.8raw.com/public/json/jmsf.json'},
            {title:'住家接口测试',url:'http://api.8raw.com/public/json/ihomebank.json'},
            {title:'虎头奔接口测试',url:'http://api.hutouben.8raw.com/public/app.json'}
        ],
